...
import com.rovger.design.chain.handler.AbstractCheckHandler;
...
//    @Autowired
//    private OrderParser[] orderParsers;
    ...
    private Result paramCheckChain(ProductVO param) {
        ...
        if (!handlerResult.isSuccess()) {
            System.out.println("责任链执行失败返回：" + handlerResult);
